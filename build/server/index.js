import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component } from './chunks/index-3df4f66e.js';
import * as cookie from 'cookie';
import { w as writable, r as readable } from './chunks/index2-6ac40de4.js';
...
class Server {
  ...
  async init({ env }) {
    ...
    if (!this.options.hooks) {
      const module = await import('./chunks/hooks.server-5f20dcdd.js');
