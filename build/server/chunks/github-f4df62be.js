import { c as create_ssr_component, j as compute_rest_props, k as createEventDispatcher, l as spread, o as escape_attribute_value, p as escape_object, e as escape$1 } from './index-3df4f66e.js';
...
const Highlight = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  {
    if (language.name && language.register) {
      ...
      highlighted = HighlightJS.highlight(code, { language: language.name }).value;
    }
  }
  ...
  )}><code class="${"hljs"}">${highlighted !== void 0 ? `<!-- HTML_TAG_START -->${highlighted}<!-- HTML_TAG_END -->` : `${escape$1(code)}`}</code></pre>
`}`;
});
...
export { Highlight as H, bash$1 as b, github$1 as g };
//# sourceMappingURL=github-f4df62be.js.map
